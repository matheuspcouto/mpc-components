...
import { MpcModalComponent, TipoModal } from './mpc-modal.component';
...
describe('MpcModalComponent', () => {
  ...
  let mockMpcModalService: jest.Mocked<MpcModalService>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: MpcModalService, useValue: mpcModalServiceMock },
        { provide: ToastrService, useValue: toastrServiceMock }
      ]
    })
      .compileComponents();

    mockMpcModalService = TestBed.inject(MpcModalService) as jest.Mocked<MpcModalService>;
