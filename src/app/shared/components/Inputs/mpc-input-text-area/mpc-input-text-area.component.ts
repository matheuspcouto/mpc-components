 ...
 * Este componente é responsável por exibir um campo de área de texto (textarea) com contagem de caracteres.
 *
 ...
 * <mpc-input-text-area [value]="value" label="Descrição" [required]="true" [tabIndex]="1" [ariaLabel]="ariaLabel" (valor)="setvalor($event)"></mpc-input-text-area>
 *
...
export class MpcInputTextAreaComponent implements OnInit {
  ...
  /**
   * Retorna a quantidade de caracteres digitados.
   */
